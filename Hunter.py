...
# gemini-2.5-flash is being locked out for newly created API keys ("no longer
# available to new users") and its free-tier quota is only 20 requests/day.
# gemini-2.5-flash-lite is Google's recommended, currently-available
# replacement with a much higher free-tier daily quota.
